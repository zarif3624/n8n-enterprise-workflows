...
| --- | --- | --- |
| `changeId` | Yes | string, pattern \S |
| `service` | Yes | string, pattern \S |
| `changeType` | Yes | string, pattern \S |
| `plannedAt` | Yes | string, date-time, pattern \S |
