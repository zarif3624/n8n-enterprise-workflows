...
- Independent decision assertions for all 79 declared policy rules plus governance, integrity, impact, report, archive, CLI, mapping, conformance, drift, schema, OpenAPI, adversarial, sensitive-data, privacy, lifecycle, and CI supply-chain coverage, increasing the suite from 58 to 218 tests.
...
- A generated SHA-256 manifest covering all 88 public generated and machine-contract artifacts.
